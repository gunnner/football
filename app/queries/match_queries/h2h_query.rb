    ...
    def h2h_match_from_db(match)
      {
        ...
        date:          match.date,
        home_team:     { id: match.home_team.id, name: match.home_team.name, logo: match.home_team.logo },
        away_team:     { id: match.away_team.id, name: match.away_team.name, logo: match.away_team.logo },
        league:        match.league ? { id: match.league.id, name: match.league.name, logo: match.league.logo } : nil
      }
    end
  end
end
